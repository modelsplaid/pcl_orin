  ...
  if (CMAKE_CUDA_COMPILER_ID STREQUAL "NVIDIA")
    if(${CUDA_VERSION_STRING} VERSION_GREATER_EQUAL "11.1")
      ...
      if(EXIT_CODE EQUAL 0)
        ...
        message( " !!!!!!!!!!!!!!1FATAL_ERROR Failed to run NVCC to get list of GPU codes: ${EXIT_CODE}")
      endif()
    ...
    elseif(${CUDA_VERSION_STRING} VERSION_GREATER_EQUAL "9.1")
      set(__CUDA_ARCH_BIN "52;53;60;61;62;70;72")
    else()
      set(__CUDA_ARCH_BIN "52;53;60;61;62;70")
    endif()
  else()
